...
//
//
//void getInstrucao(unsigned int indice, unsigned char *instrucao){
//    printf("indice:%i \n instrucao:%s", indice,instrucao);
//
//    unsigned char *metade = strtok(instrucao, " ");
//
//    if(strcmp(metade, "lda") == 0){
//        printf("Ola sou o LDA");
//    }
//    printf("\n Metade: %s",metade);
//}
//
